...
console.log( "model: " + inventory[inventory.length-1].car_model + ' Make: ' + inventory[inventory.length-1].car_make);
...
let carModelss = carModels.sort();
console.log(carModelss);
// let carModels = [];
// inventory.forEach(e => {
